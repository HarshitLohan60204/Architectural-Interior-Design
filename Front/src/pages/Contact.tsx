                ...
                <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-gray-600">support@Arkitektur.example.com</p>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-gray-600">123 Nekralisk</p>
                        <p className="text-gray-500 text-sm">Cambian Drift, DM 94103</p>
                      </div>
                    </div>
                  </div>
                </div>
